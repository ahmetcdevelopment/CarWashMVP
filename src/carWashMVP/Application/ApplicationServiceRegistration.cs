...
using Application.Services.AdvertItems;
using Application.Services.AdvertSettings;
using Application.Services.BrandSerials;
using Application.Services.Cars;
using Application.Services.Comments;
using Application.Services.Orders;
using Application.Services.OrderDetails;
using Application.Services.OrderWashers;
using Application.Services.Tenants;
using Application.Services.UserTenants;
...
public static class ApplicationServiceRegistration
{
    ...
    )
    {
        ...
        services.AddScoped<IAdvertItemService, AdvertItemManager>();
        services.AddScoped<IAdvertSettingService, AdvertSettingManager>();
        services.AddScoped<IBrandSerialService, BrandSerialManager>();
        services.AddScoped<ICarService, CarManager>();
        services.AddScoped<ICommentService, CommentManager>();
        services.AddScoped<IOrderService, OrderManager>();
        services.AddScoped<IOrderDetailService, OrderDetailManager>();
        services.AddScoped<IOrderWasherService, OrderWasherManager>();
        services.AddScoped<ITenantService, TenantManager>();
        services.AddScoped<IUserTenantService, UserTenantManager>();
        return services;
    }
